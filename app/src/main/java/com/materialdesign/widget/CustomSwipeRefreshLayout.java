package com.materialdesign.widget;
 ...
 * Description: 基于SwipeRefreshLayout的修改
 */
public class CustomSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    public CustomSwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        //mBeginDragTop = DensityUtils.dp2px(context, 10);
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        if (overscrollTop <= mTotalDragDistance * 2.5) {
            // TODO: 2015/12/22 开始刷新
            mTarget.setPadding(0, (int) overscrollTop, 0, 0);
        }
    }
    ...
    private void animateOffsetToCorrectPosition(int from, Animation.AnimationListener listener) {
        ...
        mReleaseDistance = mTarget.getPaddingTop();
        mCircleView.clearAnimation();
        mCircleView.startAnimation(mAnimateToCorrectPosition);
        //animateToRefreshPosition().start();
    }
    ...
    private final Animation mAnimateToCorrectPosition = new Animation() {
        ...
        public void applyTransformation(float interpolatedTime, Transformation t) {
            ...
            // TODO: 2015/12/22 刷新
            float range = mReleaseDistance - mTotalDragDistance;
            int yTop = (int) (mReleaseDistance - (range * interpolatedTime));
            mTarget.setPadding(0, yTop, 0, 0);
        }
    };
    ...
    private final Animation mAnimateToStartPosition = new Animation() {
        ...
        public void applyTransformation(float interpolatedTime, Transformation t) {
            ...
            // TODO: 2015/12/22 没有刷新
            int pTop = (int) (mReleaseDistance - mReleaseDistance * interpolatedTime);
            mTarget.setPadding(0, pTop, 0, 0);
        }
    };
